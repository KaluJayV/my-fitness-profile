-- Fix the final Security Definer Functions

-- Update get_core_lift_progression to use SECURITY INVOKER
...
-- Update get_current_core_lift_maxes to use SECURITY INVOKER
